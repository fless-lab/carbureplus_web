...
class CompagnieController extends Controller
{
    ...
    {
        //Retourner un tableau des transactions par mois
        $trans = Transaction::where("status", "succeed")->where("compagnie_id", session("compagnie.id"))->select("id", "updated_at", "montant")
            ->get()
